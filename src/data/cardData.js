...
const skillsData = [
  ...
  { title: "Flutter", description: "Aplication Framework", icon: flutter },
  ...
  { title: "Typescript", description: "Backend Language", icon: typescript },
  ...
  { title: "Firebase", description: "Database", icon: firebase },
];
