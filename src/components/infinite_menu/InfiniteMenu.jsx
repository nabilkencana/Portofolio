...
class IcosahedronGeometry extends Geometry {
  constructor() {
    ...
    this.addVertex(-1, t, 0, 1, t, 0, -1, -t, 0, 1, -t, 0, 0, -1, t, 0, 1, t, 0, -1, -t, 0, 1, -t, t, 0, -1, t, 0, 1, -t, 0, -1, -t, 0, 1).addFace(
      0,
      11,
      5,
      0,
...
class InfiniteGridMenu {
  ...
  #onControlUpdate(deltaTime) {
    ...
    if (!this.control.isPointerDown && Math.abs(this.smoothRotationVelocity) < 0.02) {
...
export default function InfiniteMenu({ items = [], scale = 1.0 }) {
  ...
  return (
    <div className="relative w-full h-full">
      <canvas id="infinite-grid-menu-canvas" ref={canvasRef} className="cursor-grab w-full h-full outline-none active:cursor-grabbing" />
